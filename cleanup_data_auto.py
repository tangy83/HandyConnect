#!/usr/bin/env python3
"""
Automated Data Cleanup Script for HandyConnect
...
def clean_analytics_data():
    ...
    if os.path.exists(analytics_dir):
        ...
        # Clean analytics export files
        analytics_files = [
            'tasks_export_20250927_231932.json',
            'tasks_export_20250927_232921.json',
            'tasks_export_20250927_233348.json'
        ]
        
        for filename in analytics_files:
            file_path = f"{analytics_dir}/{filename}"
            if os.path.exists(file_path):
                os.remove(file_path)
                print(f"✓ Removed {filename}")

def clean_task_backup():
    """Remove task backup file"""
    backup_file = "data/tasks.json.backup"
...
def main():
    ...
    # Step 3: Clean analytics and backups
